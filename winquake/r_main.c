...
{
	// static: too big for small stacks (not reentrant, so this is safe)
...
void R_InitTurb (void)
{
	...
	{
		sintable[i] = AMP + sinf(i*3.14159f*2.0f/CYCLE)*AMP;
		intsintable[i] = AMP2 + sinf(i*3.14159f*2.0f/CYCLE)*AMP2;	// AMP2, not 20
	}
}
